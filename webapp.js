...
function changeDisplay(choice) {
	...
	switch(choice) {
		...
		btn1.setAttribute("onClick", "changeDisplay('death4')");
			...
			case "credits1":
				save_cookies("start");
				story ="CREDITS:<br>Storyboard creators : Joshua Dedios, Alicia Wu, Pierce Dyal<br>Main coders : James Zhang, Parker Benson<br>Researchers/Supporting Coders : Jayden Cheung, Pierce Dyal<br> Cookie Coder : Joshua Dedios<br>Copyright 2017 By ThePeople ™ ";
				btn1.setAttribute("onClick", "location.reload();");
				btn1.innerHTML = "Start over";
				btn2 = "";
				break;
